...
public class MultiPaxosInstance {
    ...
    private OperationLog proposer_value;
    ...
    public MultiPaxosInstance(OperationLog proposer_value, int proposer_seq, List<Host> membership) {
    ...
    public OperationLog getProposer_value() {
        return proposer_value;
    }

    public void setProposer_value(OperationLog proposer_value) {
        this.proposer_value = proposer_value;
    }
